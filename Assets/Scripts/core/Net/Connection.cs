...
public class Connection
{
    ...
    public bool Connect(string host, int port)
    {
        try
        {
            ...
            //BeginReceive
            socket.BeginReceive(readBuff, buffCount, BUFFER_SIZE
                 - buffCount, SocketFlags.None, ReceiveCb, readBuff);
            //状态
            Debug.Log("连接成功:host:" + host + ", port:" + port);
    ...
    public bool Send(ProtocolBase protocol)
    {
        ...
        {
            Debug.LogError("[Connection]还没有连接！");
            return false;
        }
